const NAV_ITEMS = {
  member: [
    { key: 'dashboard-member',      label: 'Dashboard',      href: '/member/dashboard-member/' },
    { key: 'identitas',             label: 'Identitas Saya', href: '/member/identitas/' },
    { key: 'klaim-miles',           label: 'Klaim Miles',    href: '/member/claim-member/' },
  ...
  staf: [
    ...
    { key: 'kelola-member',      label: 'Kelola Member',            href: '/staf/kelola-member/'       },
    { key: 'kelola-klaim',       label: 'Kelola Klaim',             href: '/staf/claim-staff/'         },
